								   ...
								   <div class="col-xs-12">
								       ...
								       <div class="row">
									       <div class="col-xs-7" style="margin-top:15px;">
											   <select class="form-control member_selection">
												 <option selected disabled value="00">Select package to Edit</option>
												 <option  value="Text">package 1</option>
												 <option  value="Date">package 2</option>
												 <option  value="Number">package 3</option>
												 <option  value="Number">package 4</option>
												 <option  value="Text">package 5</option>
												</select>
												
												
										   </div>
										   <div class="col-xs-5 button_section">
											  <span style="padding-right:px;"> OR </span> <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary">Add new</button>
